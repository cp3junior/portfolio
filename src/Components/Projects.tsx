import { useContext, useLayoutEffect, useState, memo } from "react";
  ...
  return (
    <section className="section pb-10">
      <div className="container">
        ...
        <div className="row">
          {projects.map((item) => (
            <div key={item.key} className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
                  ...
                  <div className="content pt-4 pb-4 p-3">
                    ...
                    <h5 className="mb-3">
                      <span className="title text-dark">
                        {getTranslatedData(language, item, "title", "title_fr")}
                      </span>
                    </h5>
                  </div>
                </div>
